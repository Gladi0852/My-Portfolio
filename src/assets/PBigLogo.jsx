...
function PBigLogo({ size, color }) {
  return (
    <svg
      ...
      width={size}
      height={size}
      viewBox="0 0 539.000000 463.000000"
      preserveAspectRatio="xMidYMid meet"
    >
      <defs>
        <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" style={{ stopColor: "#213476", stopOpacity: 1 }} />
          <stop
            offset="100%"
            style={{ stopColor: "#1591b3", stopOpacity: 1 }}
          />
        </linearGradient>
      </defs>
      <g
        transform="translate(0.000000,463.000000) scale(0.100000,-0.100000)"
        fill={color === "null" ? "url(#gradient)" : color}
        stroke="none"
      >
        <path
